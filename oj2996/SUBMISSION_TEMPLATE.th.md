...
```text
Input ข้อความเข้ามาจากนั้น Output เป็นข้อความแบบย้อนกลับโดยใช้ [::-1] ซึ่งตอนที่ Input เข้ามาจะบังคับให้เป็นตัวอักษรพิมพ์เล็กทั้งหมดด้วย .lower() เพื่อที่จะได้ Output ออกมาเป็นพิมพ์เล็กตามที่โจทย์ต้องการ
```
...
```text
Step 1: Input ข้อความเข้ามาและบังคับให้เป็นพิมพ์เล็กด้วย .lower()
Step 2: Output ข้อความแบบย้อนกลับ
```
...
```text
เหมือนกัน เพราะเป็นวิธีที่เขียนแล้วดูสั้นและง่ายที่สุดเท่าที่คิดได้
```
...
```text
เพราะเป็นชื่อเพื่อนที่ pair ด้วย และขึ้นต้นด้วยตัวอักษรพิมพ์ใหญ่
```
...
```text
เพราะเป็นชื่อวิชา และมีการสลับอักษรพิมพ์เล็กพิมพ์ใหญ่
```
